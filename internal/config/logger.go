...
func NewLogger() Logger {
	...
	return NewLoggerWithZap(l)
}

// NewWithZap creates a new logger using the preconfigured zap logger.
func NewLoggerWithZap(l *zap.Logger) Logger {
...
func NewLogerForTest() (Logger, *observer.ObservedLogs) {
	core, recorded := observer.New(zapcore.InfoLevel)
	return NewLoggerWithZap(zap.New(core)), recorded
}

// With returns a logger based off the root logger and decorates it with the given context and arguments.
//
// If the context contains request ID (recorded via WithRequestID()) it will be added to every log message generated by the new logger.
//
